...
@ContextConfiguration(locations = "/deployerConfigContext.xml")
public class SpringTest extends AbstractJUnit4SpringContextTests {
   ...
   */
  @Test
  public void testSpringTestA() throws TicketException {
  ...
  public void testSpringTestB() throws TicketException {
    UsernamePasswordCredentials c = new UsernamePasswordCredentials();
    c.setUsername("admin");
    c.setPassword("admi");
    String ticket = centralAuthenticationService.createTicketGrantingTicket(c);
   ...
   */
  @Test
  public void testSpringTestC() throws TicketException {
    ...
    c.setYubikeyOtp("vvivijdejcktnineegdngebrugvrnbcujkjdtnficvcg");
    String ticket = centralAuthenticationService.createTicketGrantingTicket(c);
    Assert.assertNotNull(ticket);
  }
